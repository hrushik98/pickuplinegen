...
# Add the CSS styling to set the background image

st.title("Random Pickup Line Generator")
st.text("Happy valentines day 💕")
st.text("")
string = """
...
if st.button("Generate"):
    ...
    list = sentences
    random_object = random.choice(list)

    st.header(random_object)
